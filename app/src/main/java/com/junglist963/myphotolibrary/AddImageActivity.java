...
public class AddImageActivity extends AppCompatActivity {
    ...
    private EditText edtTxtAddTitle, edtTxtAddDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_activity_image);

        imageSelect = findViewById(R.id.imageSelect);
        edtTxtAddTitle = findViewById(R.id.edtTxtAddTitle);
        edtTxtAddDescription = findViewById(R.id.edtTxtAddDescription);
        ...
        btnAddImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedImage == null){
                    ...
                    String title = edtTxtAddTitle.getText().toString();
                    String description = edtTxtAddDescription.getText().toString();
